<template>
  <div class="container page2">
    <div class="top">
      <div class="top-left">更新时间： {{currentTime}}</div>
      <div class="top-middle">XXXXXXXXXX系统</div>
    ...
    <div class="middle">
      ...
      <div class="middle-center">
        <div class="totle-num">全国总计： <CountUp :end-val="num" :duration="1"></CountUp>
        </div>
      ...
      <div class="middle-right">
        ...
        <div class="chart-item">
          <div class="title">XXXXXXXXXX</div>
          <div class="item-content">
            <pieCharts ref="pieChartsBox" :data="series"></pieCharts>
          </div>
        </div>
        <div class="chart-item">
          <div class="title">XXXXXXXXXX</div>
          <div class="item-content">
            <lineChart1 ref="lineChartBox1" :data="series"></lineChart1>
          </div>
        </div>
      </div>
    </div>
...
const lineChartBox1 = ref();

const stickChartsBox = ref();
const mapChartsBox = ref();
...
.page2 {
  background-image: url(./images/content-right-border-bg.png),
    url(./images/content-left-border-bg.png), url(./images/bg_top.png),
    url(./images/header.png);
  background-position: right top, left top, center, center top; /* 定义每张图的位置 */
  background-repeat: no-repeat, no-repeat, no-repeat, no-repeat; /* 设置是否重复 */
  background-size: 100% 100%, 100% 100%, 100% 100%, 100% 10%;
